...
1. **Morris · Shin (2016) 다시 읽기** — 기록 소실 복구. S-7 에 따라 추출 기록을 세운다
2. **O-2 ★ 4편** — Pozsar·Adrian·Ashcraft·Boesky (지도) → Pozsar 2014 (위계) → Pozsar·Singh 2011 (담보 연쇄) → Pozsar 2011 (현금풀)
3. O-2 비★ 7편 — S-4 적용
4. O-3 ★ 4편
5. O-3 비★ 12편 — S-4 적용
6. 미해결 구멍 점검 → §1·§3에서 지목 재개
